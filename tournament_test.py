...
def testPairings():
    ...
    deleteMatches()
    deletePlayers()
    registerPlayer("Kamen Rider Gaim")
    registerPlayer("Kamen Rider Faiz")
    registerPlayer("Kamen Rider Stronger")
    registerPlayer("Kamen Rider Kabuto")
    registerPlayer("Kamen Rider Drive")
    registerPlayer("Kamen Rider Ryuki")
    registerPlayer("Kamen Rider Fourze")
    registerPlayer("Kamen Rider OOO")
    standings = playerStandings()
